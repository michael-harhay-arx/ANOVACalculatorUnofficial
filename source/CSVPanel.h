...
#define  CSVPANEL_LIMITLIST               3       /* control type: listBox, callback function: (none) */
...
#define  CSVPANEL_DATALIST                7       /* control type: listBox, callback function: (none) */
...
#define  CSVPANEL_FACTORLIST              11      /* control type: listBox, callback function: (none) */
